  ...
  return (
    <div className="fixed top-0 z-50">
      <div className="bg-c1 px-4 py-2 md:p-4 h-auto w-[100vw] flex items-center justify-between ">
          ...
          <>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 w-full h-full rounded-md cursor-pointer p-[1px] transition duration-300 transform hover:scale-105">
                <Link href="/login">
                  <div className="flex items-center justify-center px-5 py-2 gap-3 text-white font-semibold bg-black whitespace-nowrap h-full rounded-md">
                    Log In
                  </div>
                </Link>
              </div>
        ...
        <div className={`w-[64vw] h-[93vh] bg-c1 absolute top-14 ${sidebarPosition} transition-all ease-in-out duration-500
          rounded-l-xl shadow-lg shadow-gray-400 p-8 overflow-hidden flex flex-col justify-between md:hidden`} >
          {/* Nav links  */}
